public class OperatorlerOdev {
    ...
    // Konsola degiskenleri kullanarak iki ayri satirda sayilarin toplamini ve çarpimini yazdirin.
    // Örnek: 'Sayıların toplamı 130 dur'
    // Eğer sayıların çarpımı 3000 den büyük ve 4000 den küçükse, konsola sayıların çarpım değerlerini yazınız.
